...
| Rich badge/status tones                    | `src/primitives/Badge.tsx`; older gap doc `docs/research/2026-05-24-design-handoff-port-plan.md:269-315`                                                                                                                                                                                                                                         | The older handoff's badge tone gap has been addressed.                                                                                                                                                                    |
